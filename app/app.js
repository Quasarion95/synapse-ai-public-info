...
function syncViewportShift(){
  ...
  /* Пока человек печатает, нижней панели не место на экране.

     Сдвигать её вместе с клавиатурой мы научились, но это оказалось лечением
     не той болезни: панель при этом ездит на каждое открытие любого поля, и
     ровно это и раздражает. А нужна она в момент ввода ноль раз — человек
     пишет, а не переходит в другой раздел. Проще убрать: экран становится
     тише, и ездить нечему.

     Класс, а не inline-стиль: под него подстраивается и строка создания —
     без панели ей незачем держать над собой пустое место. */
