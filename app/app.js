...
function vAnalytics(){
  ...
  /* Карта стоит первой.
     ...
     Счётчики отвечают на «сколько», карта — на «куда это ведёт», и второе
     здесь главное: ради него в раздел и заходят. Стояла она четвёртой, под
     двумя рядами чисел и полосой дня, то есть ниже сгиба на любом телефоне —
     половина людей её просто не видела.
